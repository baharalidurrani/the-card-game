...
export const gameSlice = createSlice({
  ...
  reducers: {
    ...
    selectCardAction: selectCard,
    sortAscAction: sortAsc,
    sortDecAction: sortDec,
  },
...
export const { selectCardAction, sortAscAction, sortDecAction } = gameSlice.actions;
...
export const selectSelectedCard = (state: RootState) => state.game.selected;
