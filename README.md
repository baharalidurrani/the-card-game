...
- Components are divided into Feature, Organism, Molecule and Atom. (Feature being biggest and atom being smallest).
...
Runs the fake JSON server for serving mock responses.
